...
<body>
	...
	<%
		...
		long last_time = session.getLastAccessedTime() / 60000;//마지막접속시간
		//out.print("세션 마지막 접근 시간 : "+ last_time + "분<br>");
		long start_time = session.getCreationTime() / 60000;//세션의 생성시간
		//out.print("세션 생성 시간 : "+ start_time + "분<br>");
		long keep_time  = (last_time - start_time) / 60000;//세션 유지시간
		out.print("세션 유지 시간" + keep_time + "분");
		//session.invalidate();
	%>
</body>
</html>